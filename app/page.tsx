      ...
      <div className="scroll-container" onScroll={handleScroll}>
        ...
        <section className="relative w-full h-dvh flex flex-col justify-between bg-transparent border-t border-[rgba(255,255,255,0.02)] overflow-hidden">
          ...
          <div className="md:hidden absolute left-0 right-0 px-6 z-10" style={{ top: '72px' }}>
            ...
            <p className="mt-4 max-w-sm text-[14px] font-light tracking-wider text-neutral-400 leading-[1.6]">
                ...
                <div className="px-3 pb-3">
                  {([
                    ...
                    <div key={key} className="flex justify-between items-baseline py-1.5 border-b border-[rgba(255,255,255,0.04)] last:border-0">
                      <span className="font-mono text-[12px] tracking-[0.08em] text-neutral-500">{key}</span>
                      <span className="font-mono text-[12px] tracking-[0.08em] text-[#00F0FF]/70">{val}</span>
                    </div>
                  ))}
                </div>
              </div>
          ...
          <div className="hidden md:flex absolute left-[6%] top-1/2 -translate-y-1/2 w-[44%] flex-col justify-center z-10">
            ...
            <p className="mt-4 max-w-sm text-[15px] font-light tracking-wider text-neutral-400 leading-[1.6]">
              A 10% monthly emission stream routed directly to public infrastructure. Programmed by contract, verified by consensus — 50 years of continuous ecosystem growth.
            </p>
            ...
            <div className="border border-[rgba(0,240,255,0.1)] bg-[rgba(0,18,28,0.6)] p-6">
              ...
              {([
                ...
                <div key={key} className="flex justify-between items-baseline py-2 border-b border-[rgba(255,255,255,0.04)] last:border-0">
                  <span className="font-mono text-[11px] tracking-[0.1em] text-neutral-500">{key}</span>
                  <span className="font-mono text-[11px] tracking-[0.1em] text-[#00F0FF]/70">{val}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        <section id="portal" className="relative w-full h-dvh flex flex-col justify-between bg-transparent border-t border-[rgba(255,255,255,0.02)] overflow-hidden">
          ...
          <div className="act-v-desktop-col hidden md:flex absolute inset-0 flex-col items-center justify-center z-10 px-8">
            ...
            <p className="mt-5 text-[15px] font-light tracking-wider text-neutral-400 leading-[1.6] text-center" style={{ maxWidth: '600px' }}>
              Native omnichain architecture with a strict 1% wallet cap. Autonomous distribution network. Zero protocol fees.
            </p>
